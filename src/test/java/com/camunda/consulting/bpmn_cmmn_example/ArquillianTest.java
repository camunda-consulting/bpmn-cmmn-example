...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "bpmn-cmmn-example";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "bpmn-cmmn-example.war")
            ...
            .addPackages(false, "com.camunda.consulting.bpmn_cmmn_example") // not recursive to skip package 'nonarquillian'
